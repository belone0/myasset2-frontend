    ...
    <div class="w-full max-w-sm rounded-lg shadow-md bg-gray-800 text-gray-100 p-6">
      ...
      <form @submit.prevent="handleSubmit" class="flex flex-col space-y-4">
        ...
        <div class="flex flex-col space-y-1">
          ...
          <input id="password" v-model="password" type="password" placeholder="Enter your password" required class="px-3 py-2 rounded bg-gray-700 text-gray-100 border border-gray-600
                     focus:outline-none focus:ring-2 focus:ring-purple-500
                     placeholder-gray-400" />
        </div>
...
.app-bg {
  ...
  background-image:
    radial-gradient(circle at -25% -25%, rgba(147, 51, 234, 0.5), transparent 40%),
    radial-gradient(circle at 125% 125%, rgba(147, 51, 234, 0.5), transparent 40%);
